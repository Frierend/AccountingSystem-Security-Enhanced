...
{
    /// <inheritdoc />
    public partial class AddIdentityGroundwork : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "identity-role-admin", "Admin", "ADMIN" },
                    { 2, "identity-role-accounting", "Accounting", "ACCOUNTING" },
                    { 3, "identity-role-management", "Management", "MANAGEMENT" },
                    { 4, "identity-role-superadmin", "SuperAdmin", "SUPERADMIN" }
                });
